...
function GettCreateShare(dataLogin) { // pass your data in method
	GettAddFile(dataLogin.accesstoken, "2nL8Zpj2");
	return;
	$.ajax({
		type: "POST",
...
function GettUploadFile(posturl) {
	...
	var fd = new FormData();    
	fd.append( 'file', 'd:\myfile.txt' );
	
	$.ajax({
		url: 'http://b3.ge.tt/upload/54d8ac952085e8b7cfa42a9bab9a2b9fe5e02c5e634191178d9eec9648b0f4fbc0cfba9bfd3d391403ccde44d9c13ff5162fd13059929481ac8599696588589c785df536d9d0787b2d4f100e1df45241ae742bd427835b936f65f118651696412f997760b232c0d0a95e3081396d42eb',
		data: fd,
		processData: false,
		contentType: false,
		type: 'PUT',
	...
	// console.log("Sucesso UploadFile!");
	// },
	// error: function(jqXHR, status) {
